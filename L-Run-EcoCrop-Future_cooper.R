# Set variables
src.dir <- "Y:\gtaba\2030_2_5\scripts"
cropParamFile <- "Y:\gtaba\2030_2_5\Bean_parameters/parametros.csv"
cropDir <- "Y:\gtaba\2030_2_5\Ecocrop_2s"
...
crop <- "crop"
fDir <- "Y:/gtaba/2030_2_5/Ecocrop_Future_var"
...
gls <- list.files("Y:/gtaba/2030_2_5/Ecocrop_Future_var") 
#Linux
...
#<- c("bccr_bcm2_0","cccma_cgcm3_1_t47","cccma_cgcm3_1_t63","cnrm_cm3","csiro_mk3_0",
...
for (gcm in gls) {
  ...
  aDir <- paste(fDir, "/", gcm, "/r1i1p1/2020_2049/_asciis", sep="")  #Folder of future climate data
